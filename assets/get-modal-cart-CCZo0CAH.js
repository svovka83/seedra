import{H as e,_ as t,h as n}from"./index.esm-DIgIDhqE.js";import{t as r}from"./product-counter-CypSgduo.js";import{t as i}from"./empty-cart-CJa4tPAu.js";function a(e,t,n,i,a){return`
  ...
  `}async function o(r){let o=document.querySelector(`.modal-cart__products`);o&&n(t(e(r,`cart`)),e=>{let t=``;e.forEach(e=>{t+=a(e.id,e.data().name,e.data().imageUrl,e.data().quantity,e.data().price)}),o.innerHTML=t,o.innerHTML===``&&(o.innerHTML=i(`cart`,`cart-icon`))})}export{o as t};